...
export const metadata: Metadata = {
  ...
  title:
    "Morocco Tours from Casablanca | Private Desert & City Tours",

  description:
    "Explore private Morocco tours from Casablanca including Sahara Desert adventures, Marrakech, Fes and cultural journeys across Morocco.",

  alternates: {
    canonical:
      `${SITE_URL}/tours/from-casablanca`,
  },

  openGraph: {

    title:
      "Morocco Tours from Casablanca | Moroccan Trip",

    description:
      "Discover private tours starting from Casablanca to Morocco's imperial cities, Sahara Desert and unforgettable destinations.",
...
export default function ToursFromCasablancaPage() {
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-[hsl(var(--text-secondary))] sm:text-lg">
              ...
              Discover Morocco with private tours starting from Casablanca.
              Explore historic cities, Sahara Desert landscapes, mountain
              routes and cultural experiences with a flexible itinerary.
      ...
      <section className="mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-10">
        ...
        <div className="max-w-3xl">
          ...
          <h2 className="text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
            ...
            Explore Morocco Starting from Casablanca
          ...
          <p className="mt-5 leading-8 text-[hsl(var(--text-secondary))]">
            ...
            Casablanca is an ideal starting point for discovering Morocco.
            From this Atlantic city, travelers can continue toward imperial
            cities, traditional villages, mountain landscapes and the Sahara
            Desert.
          ...
          <p className="mt-5 leading-8 text-[hsl(var(--text-secondary))]">
            ...
            Our private tours from Casablanca are designed for travelers who
            want comfort, flexibility and a personalized way to experience
            Morocco.
        ...
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-10 lg:py-20">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <p className="text-sm text-[hsl(var(--text-muted))]">
              ...
              {casablancaTours.length} tours available
      ...
      <section className="bg-[hsl(var(--secondary))]">
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
          ...
          <h2 className="text-4xl font-semibold text-white">
            ...
            Start Your Morocco Adventure from Casablanca
          ...
          <p className="mt-5 max-w-2xl leading-8 text-white/70">
            ...
            itinerary that matches your interests and available time.
