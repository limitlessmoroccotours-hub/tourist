...
export const metadata: Metadata = {
  ...
  title:
    "Errachidia Desert Tours | Merzouga & Sahara Experiences",

  description:
    "Discover private Errachidia desert tours to Merzouga, Erg Chebbi and the Sahara Desert through Ziz Valley, Erfoud and southeastern Morocco.",

  alternates: {
    canonical:
      `${SITE_URL}/tours/from-errachidia`,
  },
  ...
  openGraph: {
    ...
    title:
      "Errachidia Desert Tours | Sahara Experiences",

    description:
      "Explore private desert tours from Errachidia to Merzouga, Erg Chebbi and the Sahara Desert with Moroccan Trip.",
...
export default function ToursFromErrachidiaPage() {
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-[hsl(var(--primary))]">
              ...
              Sahara From Southeastern Morocco
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-[hsl(var(--text-secondary))] sm:text-lg">
              ...
              Discover private Errachidia desert tours connecting the Ziz Valley,
              Erfoud, Merzouga and the Sahara Desert. Experience southeastern
              Morocco through a shorter desert journey focused on landscapes,
      ...
      <section className="mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-10">
        ...
        <div className="max-w-3xl">
          ...
          <h2 className="text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
            ...
            Explore the Sahara from Errachidia
          ...
          <p className="mt-5 leading-8 text-[hsl(var(--text-secondary))]">
            ...
            Errachidia is a convenient starting point for travelers who want to
            discover the Sahara Desert without the long transfer times often
            required from Marrakech or Fes.
          ...
          <p className="mt-5 leading-8 text-[hsl(var(--text-secondary))]">
            ...
            Our desert tours from Errachidia take you through the changing
            landscapes of southeastern Morocco, including the Ziz Valley,
            Erfoud and the dunes of Erg Chebbi near Merzouga.
          ...
          <p className="mt-5 leading-8 text-[hsl(var(--text-secondary))]">
            ...
            These private experiences combine desert scenery, local culture and
            flexible travel planning for visitors who want to explore the Sahara
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
                ...
                Discover Our Errachidia Desert Tours
            ...
            <p className="text-sm text-[hsl(var(--text-muted))]">
              ...
              {errachidiaTours.length} tours available
      ...
      <section className="bg-[hsl(var(--secondary))]">
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
          ...
          <h2 className="text-4xl font-semibold text-white">
            ...
            Start Your Sahara Journey from Errachidia
          ...
          <p className="mt-5 max-w-2xl leading-8 text-white/70">
            ...
            Contact us to plan a private desert experience through Merzouga,
            Erg Chebbi and southeastern Morocco.
