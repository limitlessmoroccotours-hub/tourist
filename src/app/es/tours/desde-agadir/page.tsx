// app/es/tours/desde-agadir/page.tsx
...
export const metadata: Metadata = {
  ...
  title:
    "Tours desde Agadir | Circuitos privados por Marruecos",

  description:
    "Descubre tours desde Agadir por Marruecos con el desierto del Sahara, Merzouga, Marrakech y experiencias privadas.",

  alternates: {
    canonical:
      `${SITE_URL}/es/tours/desde-agadir`,
  },
  ...
  openGraph: {
    ...
    description:
      "Explora circuitos privados desde Agadir hacia el Sahara y los mejores destinos de Marruecos.",
...
export default function ToursDesdeAgadirPage() {
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-[hsl(var(--primary))]">
              ...
              Explora Marruecos desde Agadir
            ...
            <h1 className="mt-4 text-4xl font-semibold leading-[1.05] tracking-[-0.04em] text-[hsl(var(--heading))] sm:text-5xl lg:text-6xl">
              ...
              Tours desde Agadir y experiencias privadas por Marruecos
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-[hsl(var(--text-secondary))] sm:text-lg">
              ...
              Descubre viajes privados desde Agadir hacia el desierto
              del Sahara, Marrakech y los destinos más increíbles de Marruecos.
      ...
      <section className="mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-10">
        ...
        <div className="max-w-3xl">
          ...
          <h2 className="text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
            ...
            Tours privados desde Agadir para descubrir Marruecos
          ...
          <p className="mt-5 leading-8 text-[hsl(var(--text-secondary))]">
            ...
            Agadir es un excelente punto de partida para explorar el sur
            de Marruecos. Desde esta ciudad puedes viajar hacia el Sahara,
            Merzouga, Marrakech y otros destinos únicos.

            Nuestros tours desde Agadir ofrecen transporte cómodo,
            flexibilidad y una experiencia personalizada.
  ...
  <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
    ...
    <div>
      ...
      <h2 className="mt-3 text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
        ...
        Explora nuestros circuitos desde Agadir
    ...
    <p className="text-sm text-[hsl(var(--text-muted))]">
      ...
      {agadirTours.length} tours disponibles
...
<div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
  ...
  <h2 className="text-4xl font-semibold text-white">
    ...
    Planifica tu viaje desde Agadir por Marruecos
  ...
  <p className="mt-5 max-w-2xl leading-8 text-white/70">
    ...
    Cuéntanos tus planes de viaje y crearemos una experiencia privada
