...
export const metadata: Metadata = {
  ...
  title:
    "Excursiones desde Marrakech | Tours privados por Marruecos",

  description:
    "Descubre excursiones desde Marrakech al desierto del Sahara, Merzouga, las montañas del Atlas y los mejores destinos de Marruecos.",

  alternates: {
    canonical:
      `${SITE_URL}/es/tours/desde-marrakech`,
  },
  ...
  openGraph: {
    ...
    description:
      "Explora tours privados desde Marrakech al Sahara, las montañas del Atlas y los destinos más impresionantes de Marruecos.",
...
export default function ToursDesdeMarrakechPage() {
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-[hsl(var(--primary))]">
              ...
              Explora Marruecos desde Marrakech
            ...
            <h1 className="mt-4 text-4xl font-semibold leading-[1.05] tracking-[-0.04em] text-[hsl(var(--heading))] sm:text-5xl lg:text-6xl">
              ...
              Excursiones desde Marrakech al desierto y experiencias privadas en Marruecos
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-[hsl(var(--text-secondary))] sm:text-lg">
              ...
              Descubre tours privados desde Marrakech con aventuras en el Sahara,
              paisajes del Alto Atlas y viajes inolvidables por Marruecos.
      ...
      <section className="mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-10">
        ...
        <div className="max-w-3xl">
          ...
          <h2 className="text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
            ...
            Tours privados desde Marrakech para descubrir Marruecos
          ...
          <p className="mt-5 leading-8 text-[hsl(var(--text-secondary))]">
            ...
            Marrakech es uno de los mejores puntos de salida para explorar Marruecos.
            Desde la ciudad puedes descubrir el Alto Atlas, pueblos tradicionales,
            antiguas kasbahs y el desierto del Sahara.

            Nuestros tours privados desde Marrakech están diseñados para viajeros
            que buscan transporte cómodo, flexibilidad y una experiencia personalizada.
  ...
  <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
    ...
    <div>
      ...
      <h2 className="mt-3 text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
        ...
        Explora nuestras excursiones desde Marrakech
    ...
    <p className="text-sm text-[hsl(var(--text-muted))]">
      ...
      {marrakechTours.length} tours disponibles
...
<div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
  ...
  <h2 className="text-4xl font-semibold text-white">
    ...
    Planifica tu tour por Marruecos desde Marrakech
