...
export const metadata: Metadata = {
  ...
  title:
    "Excursiones desde Casablanca | Tours privados por Marruecos",

  description:
    "Descubre excursiones desde Casablanca al desierto del Sahara, Marrakech, Fez y los mejores destinos de Marruecos.",

  alternates: {
    canonical:
      `${SITE_URL}/es/tours/desde-casablanca`,
  },
  ...
  openGraph: {
    ...
    description:
      "Explora tours privados desde Casablanca hacia el Sahara, Marrakech, Fez y los destinos más impresionantes de Marruecos.",
...
export default function ToursDesdeCasablancaPage() {
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-[hsl(var(--primary))]">
              ...
              Explora Marruecos desde Casablanca
            ...
            <h1 className="mt-4 text-4xl font-semibold leading-[1.05] tracking-[-0.04em] text-[hsl(var(--heading))] sm:text-5xl lg:text-6xl">
              ...
              Excursiones desde Casablanca y experiencias privadas en Marruecos
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-[hsl(var(--text-secondary))] sm:text-lg">
              ...
              Descubre tours privados desde Casablanca hacia el desierto del Sahara,
              Marrakech, Fez y los lugares más impresionantes de Marruecos.
      ...
      <section className="mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-10">
        ...
        <div className="max-w-3xl">
          ...
          <h2 className="text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
            ...
            Tours privados desde Casablanca para descubrir Marruecos
          ...
          <p className="mt-5 leading-8 text-[hsl(var(--text-secondary))]">
            ...
            Casablanca es uno de los principales puntos de llegada a Marruecos.
            Desde la ciudad puedes comenzar viajes privados hacia Marrakech,
            el desierto del Sahara, Fez y otros destinos increíbles.

            Nuestros tours privados desde Casablanca están diseñados para viajeros
  ...
  <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
    ...
    <div>
      ...
      <h2 className="mt-3 text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
        ...
        Explora nuestras excursiones desde Casablanca
    ...
    <p className="text-sm text-[hsl(var(--text-muted))]">
      ...
      {casablancaTours.length} tours disponibles
...
<div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
  ...
  <h2 className="text-4xl font-semibold text-white">
    ...
    Planifica tu viaje a Marruecos desde Casablanca
