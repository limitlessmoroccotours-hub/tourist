...
export const metadata: Metadata = {
  ...
  title:
    "Excursiones desde Fez | Tours privados por Marruecos",

  description:
    "Descubre excursiones desde Fez al desierto del Sahara, Merzouga, Marrakech y los mejores destinos de Marruecos.",

  alternates: {
    canonical:
      `${SITE_URL}/es/tours/desde-fez`,
  },
  ...
  openGraph: {
    ...
    description:
      "Explora tours privados desde Fez hacia el Sahara, Marrakech y los destinos más impresionantes de Marruecos.",
...
export default function ToursDesdeFezPage() {
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10 lg:py-24">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="mt-4 text-4xl font-semibold leading-[1.05] tracking-[-0.04em] text-[hsl(var(--heading))] sm:text-5xl lg:text-6xl">
              ...
              Excursiones desde Fez al desierto y experiencias privadas en Marruecos
            ...
            <p className="mt-6 max-w-2xl text-base leading-8 text-[hsl(var(--text-secondary))] sm:text-lg">
              ...
              Descubre tours privados desde Fez con aventuras en el desierto del Sahara,
              Merzouga, Marrakech y los lugares más increíbles de Marruecos.
      ...
      <section className="mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-10">
        ...
        <div className="max-w-3xl">
          ...
          <h2 className="text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
            ...
            Tours privados desde Fez para descubrir Marruecos
          ...
          <p className="mt-5 leading-8 text-[hsl(var(--text-secondary))]">
            ...
            Fez es una de las ciudades históricas más importantes de Marruecos.
            Desde la ciudad puedes comenzar viajes privados hacia el desierto del Sahara,
            Merzouga, Marrakech y otros destinos únicos.

            Nuestros tours desde Fez ofrecen transporte cómodo, flexibilidad
            y una experiencia personalizada por Marruecos.
  ...
  <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
    ...
    <div>
      ...
      <h2 className="mt-3 text-3xl font-semibold text-[hsl(var(--heading))] sm:text-4xl">
        ...
        Explora nuestras excursiones desde Fez
    ...
    <p className="text-sm text-[hsl(var(--text-muted))]">
      ...
      {fezTours.length} tours disponibles
...
<div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-10">
  ...
  <h2 className="text-4xl font-semibold text-white">
    ...
    Planifica tu tour por Marruecos desde Fez
